...
public class Register extends BaseTest {
    ...
    public void RegisterTest() {
        ...
        List<WebElement> Gender = Driver.findElements(By.xpath("//ul[@data-componentname='gender']/li"));
        Gender.get(0).click();

        WebElement News = Driver.findElement(By.xpath("//label[@class='checkbox']"));
        News.click();

        WebElement JoinUsButton = Driver.findElement(By.xpath("//input[@value='JOIN US']"));
        JoinUsButton.click();
